...
const Filter = () => {
	...
	return (
		<section className="border-solid border-gray-400 border-2 w-fit pl-8 pr-6 pb-2 h-fit">
			<div className="flex items-center gap-3 pt-2 pb-2">
				<IoOptionsOutline className="size-7" /> <h4>FILTER</h4>
			</div>
